    ...
    def networkDelayTime(self, times, n, k):
        ...
        def bfs(curr):
            ...
            while(len(queue) > 0):
                curr, time = queue.pop()
                visited[curr] = 1
                for next_curr, next_time in adj[curr]:
                    if visited[next_curr] == 0: 
                        queue.append((next_curr, time+next_time))
            if sum(visited) == n:
                return max_time
            return -1
        return bfs(k-1)
